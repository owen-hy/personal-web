...
During this program, I had the honor of working with the Cancer Data Science team, being mentored by Dr. Veera Baladandayuthapani, Dr. Junsouk Choi, and Grant Carr. My project involves using spatial statistics and hierarchical clustering to see if any similar behaviors in the lung tumor microenvironment has any indications for patient metadata, with a particular focus on cancer recurrence using basic survival analysis. Feel free to read over my poster and reach out if you have any questions!

<div style="text-align: center;">
  <img src="images/cancer-poster.jpg" alt="BDSI Poster" width="500"/>
  <br/>
</div>
